<template>
  <div class="details-box"  v-title data-title="阵地活动">
    <div class="content-box">
      ...
      <p class="text-box">所在地区：{{detils.area}} 招募人数：<span>{{detils.joinNumber}}</span>/{{detils.targetNumber}}</p>
    </div>
    <div class="content-box">
...
export default {
  ...
  methods:{
    ...
    detaDelist(){
      ...
      $.ajax({
        url:config.zdhdx,
        // url:'http://171.211.195.164:8077/common-web/a/position-activity/find',
        data:{id:this.id},
        success:res=>{
